        ...
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          <div>
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl md:text-4xl font-extrabold drop-shadow text-white">AC Repair Booking</h1>
            ...
            <div className="mt-3 flex gap-3 items-center">
              <span className="badge bg-white text-black px-2 py-0.5 rounded-full">✓ Trusted</span>
